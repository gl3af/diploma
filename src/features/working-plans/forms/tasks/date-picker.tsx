...
type DatePickerProps = ComponentsProps<"deadline"> & {
  maxDate: Date;
};

export function DatePicker({ field, fieldState, maxDate }: DatePickerProps) {
  return (
        ...
        <PopoverTrigger asChild>
          ...
          >
            <Button
              variant="outline"
              className={cn(
                "text-md w-full pl-3 text-left font-medium",
